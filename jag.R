...
sampleFiles <- list.files(path=directory, pattern='WT|jag')
exclude_patterns <- 'ALL_merged'
sampleFiles <- sampleFiles[!grepl(exclude_patterns, sampleFiles)]

sampleFiles

sampleNames <- c('jag_1', 'jag_2', 'jag_3', 'WT_1', 'WT_2', 'WT_3')

OD = c(2, 2, 1, 2, 2, 1)

Names <- c('jag_1', 'jag_2', 'jag_3', 'WT_1', 'WT_2', 'WT_3')

Strain <- c('jag', 'jag', 'jag', 'WT', 'WT', 'WT')
...
colData(dds)$strain<-factor(colData(dds)$strain, levels=c('WT','jag'))
...
output_file <- file.path(output_dir, "PCA_plot_jag.pdf")
...
res <- results(dds, contrast = c("strain", "jag", "WT")) 
...
# Specify the output directory and file name
output_dir <- "/Users/andreas/Bacillus/Bioinformatics/RNAseq_jag_khpa_kre/X204SC22071444-Z01-F001/Analysis/figures/"
output_file <- file.path(output_dir, "Volcano_plot_jag.pdf")
# Save the plot as a PDF file
...
output_file <- file.path(output_dir, "jag_DEG.txt")
...
gene_list_file <- "/Users/andreas/Bacillus/Bioinformatics/RNAseq_jag_khpa_kre/X204SC22071444-Z01-F001/Analysis/DEG_significant/jag_DEG.txt_sig_genes_BSU_Numbers.txt"
...
genes_of_interest <- genes_of_interest[1:200]

### CRAC
# Specify the path to your gene list file
gene_list_file <- "/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/ratios/prepared/jag_ratios.txt_sig_genes_BSU_Numbers.txt"
# Read the gene list into R
genes_of_interest <- read.table(gene_list_file, header = FALSE, stringsAsFactors = FALSE)
genes_of_interest <- as.character(genes_of_interest$V1)
genes_of_interest <- unique(genes_of_interest)
#genes_of_interest <- genes_of_interest[1:100]
...
# View results
print(go_enrichment)
go_enrichment[go_enrichment$ID == "Secreted proteins", ]
# View(go_enrichment)
# 
...
my_dotplot <- dotplot(go_enrichment, showCategory = 11) + 
  labs(title = "Jag") +
  theme(
...
output_file <- file.path(output_dir, "Dotplot_GSEA_jag_CRAC.pdf")
# Save the plot as a PDF file
ggsave(output_file, plot = my_dotplot, width = 8, height = 6)

######################
### GO terms in CRAC overlap
### jag and khpA
# Specify the path to your gene list file
...
overlap_all <- Reduce(intersect, list(jag_CRAC$V1, khpA_CRAC$V1, kre_CRAC$V1))
overlap_all
overlap_jag_khpA <- Reduce(intersect, list(jag_CRAC$V1, khpA_CRAC$V1))
overlap_jag_khpA_only <- setdiff(overlap_jag_khpA, overlap_all)

genes_of_interest <- overlap_jag_khpA_only
genes_of_interest <- unique(genes_of_interest)
...
output_dir <- "/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/figures"
#output_file <- file.path(output_dir, "Dotplot_GSEA_jag_RNAseq.pdf")
output_file <- file.path(output_dir, "Dotplot_GSEA_jag_khpA_CRAC_overlap.pdf")
# Save the plot as a PDF file
ggsave(output_file, plot = my_dotplot, width = 8, height = 6)
...
genes_of_interest <- Reduce(intersect, list(jag_CRAC$V1, kre_CRAC$V1))
genes_of_interest <- unique(genes_of_interest)
# Perform GO-like enrichment analysis
go_enrichment <- enricher(genes_of_interest, TERM2GENE = TERM2GENE, TERM2NAME = TERM2NAME)
...
output_dir <- "/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/figures"
#output_file <- file.path(output_dir, "Dotplot_GSEA_jag_RNAseq.pdf")
output_file <- file.path(output_dir, "Dotplot_GSEA_jag_kre_CRAC_overlap.pdf")
# Save the plot as a PDF file
ggsave(output_file, plot = my_dotplot, width = 8, height = 6)
...
genes_of_interest <- Reduce(intersect, list(khpA_CRAC$V1, kre_CRAC$V1))
genes_of_interest <- unique(genes_of_interest)
# Perform GO-like enrichment analysis
go_enrichment <- enricher(genes_of_interest, TERM2GENE = TERM2GENE, TERM2NAME = TERM2NAME)
...
output_dir <- "/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/figures"
#output_file <- file.path(output_dir, "Dotplot_GSEA_jag_RNAseq.pdf")
output_file <- file.path(output_dir, "Dotplot_GSEA_khpA_kre_CRAC_overlap.pdf")
# Save the plot as a PDF file
ggsave(output_file, plot = my_dotplot, width = 8, height = 6)


### GO terms in jag only genes
jag_CRAC = read.csv('/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/ratios/prepared/jag_ratios.txt_sig_genes_BSU_Numbers.txt', sep = '\t', header = FALSE)
khpA_CRAC = read.csv('/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/ratios/prepared/khpA_ratios.txt_sig_genes_BSU_Numbers.txt', sep = '\t', header = FALSE)
kre_CRAC = read.csv('/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/ratios/prepared/kre_ratios.txt_sig_genes_BSU_Numbers.txt', sep = '\t', header = FALSE)

overlap_kre_jag <- Reduce(intersect, list(kre_CRAC$V1, jag_CRAC$V1))
overlap_jag_khpA <- Reduce(intersect, list(jag_CRAC$V1, khpA_CRAC$V1))
jag_only <- setdiff(setdiff(jag_CRAC$V1, overlap_kre_jag), overlap_jag_khpA)

genes_of_interest <- jag_only
genes_of_interest <- unique(genes_of_interest)
...
### GO terms in khpA only genes
jag_CRAC = read.csv('/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/ratios/prepared/jag_ratios.txt_sig_genes_BSU_Numbers.txt', sep = '\t', header = FALSE)
khpA_CRAC = read.csv('/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/ratios/prepared/khpA_ratios.txt_sig_genes_BSU_Numbers.txt', sep = '\t', header = FALSE)
kre_CRAC = read.csv('/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_19thJune2024/ratios/prepared/kre_ratios.txt_sig_genes_BSU_Numbers.txt', sep = '\t', header = FALSE)

overlap_kre_khpA <- Reduce(intersect, list(kre_CRAC$V1, khpA_CRAC$V1))
overlap_jag_khpA <- Reduce(intersect, list(jag_CRAC$V1, khpA_CRAC$V1))
khpA_only <- setdiff(setdiff(khpA_CRAC$V1, overlap_kre_khpA), overlap_jag_khpA)

genes_of_interest <- khpA_only
genes_of_interest <- unique(genes_of_interest)
...
overlap_kre_jag <- Reduce(intersect, list(kre_CRAC$V1, jag_CRAC$V1))
overlap_kre_khpA <- Reduce(intersect, list(kre_CRAC$V1, khpA_CRAC$V1))
kre_only <- setdiff(setdiff(kre_CRAC$V1, overlap_kre_jag), overlap_kre_khpA)

genes_of_interest <- kre_only
genes_of_interest <- unique(genes_of_interest)
...
######################
### GO terms in RNAseq-CRAC overlap
### jag
# Specify the path to your gene list file
...
jag_CRAC = read.csv('/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_30thMay2024/ratios/prepared/jag_ratios.txt_sig_genes_BSU_Numbers.txt', sep = '\t', header = FALSE)

genes_of_interest <- Reduce(intersect, list(jag_RNA$V1, jag_CRAC$V1))
...
#output_file <- file.path(output_dir, "Dotplot_GSEA_jag_RNAseq.pdf")
output_file <- file.path(output_dir, "Dotplot_GSEA_jag_RNAseqCRAC_overlap.pdf")
# Save the plot as a PDF file
ggsave(output_file, plot = my_dotplot, width = 8, height = 6)
...
khpA_CRAC = read.csv('/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_30thMay2024/ratios/prepared/khpA_ratios.txt_sig_genes_BSU_Numbers.txt', sep = '\t', header = FALSE)

genes_of_interest <- Reduce(intersect, list(khpA_RNA$V1, khpA_CRAC$V1))
...
output_dir <- "/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_30thMay2024/figures"
#output_file <- file.path(output_dir, "Dotplot_GSEA_jag_RNAseq.pdf")
output_file <- file.path(output_dir, "Dotplot_GSEA_khpA_RNAseqCRAC_overlap.pdf")
# Save the plot as a PDF file
ggsave(output_file, plot = my_dotplot, width = 8, height = 6)
...
kre_CRAC = read.csv('/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_30thMay2024/ratios/prepared/kre_ratios.txt_sig_genes_BSU_Numbers.txt', sep = '\t', header = FALSE)

genes_of_interest <- Reduce(intersect, list(kre_RNA$V1, kre_CRAC$V1))
...
output_dir <- "/Users/andreas/Bacillus/Bioinformatics/CRAC_jag_khpA_kre_30thMay2024/figures"
#output_file <- file.path(output_dir, "Dotplot_GSEA_jag_RNAseq.pdf")
output_file <- file.path(output_dir, "Dotplot_GSEA_kre_RNAseqCRAC_overlap.pdf")
# Save the plot as a PDF file
ggsave(output_file, plot = my_dotplot, width = 8, height = 6)
...
# Specify the path to your gene list file
gene_list_file <- "/Users/andreas/Bacillus/Bioinformatics/RNAseq_jag_khpa_kre/X204SC22071444-Z01-F001/Analysis/DEG_significant/jag_DEG.txt_sig_genes_BSUNumbers_no_underscore.txt"
# Read the gene list into R
genes_of_interest <- read.table(gene_list_file, header = FALSE, stringsAsFactors = FALSE)
genes_of_interest <- as.character(genes_of_interest$V1)
...
# Specify the output directory and file name
output_dir <- "/Users/andreas/Bacillus/Bioinformatics/RNAseq_jag_khpa_kre/X204SC22071444-Z01-F001/Analysis/figures/"
output_file <- file.path(output_dir, "Dotplot_KEGG_jag.pdf")
# Save the plot as a PDF file
